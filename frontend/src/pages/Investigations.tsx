...
function Investigations() {
  ...
  function handleResolveInvestigation() {
    setStatus("Resolved");
        ...
        <header className="flex flex-wrap items-start justify-between gap-5">
          <div>
            ...
            <p className="mt-2 text-slate-400">
              Review evidence, document analyst findings,
              and track response actions.
            </p>
          </div>
              ...
              <div className="flex flex-wrap items-start justify-between gap-5">
                <div>
                  <p className="text-sm text-slate-500">
                    {investigation
                      ? `Saved investigation #${investigation.id}`
                      : "New investigation"}
                  </p>
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-800 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">
                      Update the current investigation
                      state.
                    </p>
                  </div>
                </div>
            ...
            <section className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-6">
              ...
              <div className="mt-6 space-y-3">
                {selectedDetection
                  ...
                  <p className="rounded-lg border border-slate-700 bg-slate-950/40 p-4 text-sm text-slate-400">
                    No recommended actions are
            ...
            <section className="rounded-xl border border-slate-700 bg-slate-800 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Document findings, decisions, and
                    response activity.
                  </p>
                </div>
              </div>
            ...
            <section className="rounded-xl border border-slate-700 bg-slate-800 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Events connected to the source IP or
                    affected accounts.
                  </p>
                </div>
              </div>
            ...
            <section className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-slate-700 bg-slate-800 p-6">
              <div>
                {saveMessage ? (
                  ...
                  <p className="text-sm text-slate-400">
                    Save your notes, status, analyst,
                    and completed actions before leaving.
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg border border-blue-500 px-5 py-3 font-medium text-blue-400 transition hover:bg-blue-500/10 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {isSavingInvestigation ? (
                    <Loader2 className="h-5 w-5 animate-spin" />
                  ) : (
                ...
                <button
                  ...
                  onClick={
                    handleResolveInvestigation
                  }
                  className="flex items-center gap-2 rounded-lg bg-green-600 px-5 py-3 font-medium text-white transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  <CheckCircle2 className="h-5 w-5" />
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-10 rounded-xl border border-dashed border-slate-600 bg-slate-800 p-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-slate-400">
            Upload and analyze a security log before
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-10 rounded-xl border border-green-500/30 bg-green-500/10 p-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-green-300">
            The latest analysis did not generate any
            security detections.
          </p>
